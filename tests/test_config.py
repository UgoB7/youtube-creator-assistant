...
class ConfigTests(unittest.TestCase):
    ...
    def test_load_lofi_visual_prompt_generation_config(self):
        ...
        self.assertIn("90s Japanese anime aesthetic", settings.replicate.image_prompt_prefix)
        ...
        self.assertTrue(settings.topaz.enabled)
        self.assertEqual(settings.topaz.api_key_env, "TOPAZ_API_KEY")
        self.assertEqual(settings.topaz.model, "astra")
        self.assertEqual(settings.topaz.output_suffix, "_astra")
        self.assertTrue(settings.screen_replace.enabled)
        self.assertEqual(settings.screen_replace.overlay_video_path.name, "lofi_overlay.local.mp4")
        self.assertEqual(settings.screen_replace.quad_norm, "0.43,0.36;0.74,0.37;0.73,0.61;0.42,0.60")
        self.assertEqual(settings.screen_replace.output_filename, "render_visual_screen_replace.mp4")
        self.assertTrue(settings.screen_replace.overlay_builder.enabled)
        self.assertEqual(settings.screen_replace.overlay_builder.project_dir.name, "screen_overlay")
        self.assertEqual(settings.screen_replace.overlay_builder.source_assets_dir.name, "source")
        self.assertEqual(settings.screen_replace.overlay_builder.output_video_path.name, "lofi_overlay.local.mp4")
        self.assertEqual(settings.screen_replace.overlay_builder.browser_executable_path.name, "Chromium")
        self.assertEqual(settings.screen_replace.overlay_builder.composition_id, "Overlay4K")
